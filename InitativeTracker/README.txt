...
This was implemented by making a custom Character object that keeps track of anything needed to know about the character, such as:
	Name, Initative, Initative modifier, PC or not. I might add more stats later.
...
There are two ways of modifying the list: 
	...
	Interacting with the UI to add a character or change an initative value.
...
Currently implemented:
	...
	Distinguishing between PCs and NPCs by deleting NPCs at the beginning of battle and having the option to automatically roll for NPCs for initative.
	Right-clicking the list to remove characters / change their initative.

TODO:
	Improve window for changing initative. Right now it is too big, I want it to be more streamlined. 
	Add support for Iniative modifier, such as one based on Dex. Initative Modifier is already tracked in Character object, just need to figure out how to implement.
